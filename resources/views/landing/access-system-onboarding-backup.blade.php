    ...
    <div class="onboarding-card">
        ...
        <div class="explainer-side">
            <div class="explainer-content">
                ...
                <p class="explainer-description">
                    Streamline your educational operations with our comprehensive platform designed for modern schools and
                    institutions.
                </p>
        ...
        <div class="action-side">
            ...
            <div class="support-section">
                ...
                <!-- Back to Home -->
                <div class="mt-4 pt-3 border-top" style="border-color: var(--gray-200) !important;">
                    <div class="text-center">
                        <a href="{{ url('/') }}" class="support-btn">
