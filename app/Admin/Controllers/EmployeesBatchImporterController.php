...
class EmployeesBatchImporterController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Employees batch import';
    ...
    protected function form()
    {
        ...
        $form->hidden('type', __('type'))->default('employees')->rules('required');
        $form->hidden('academic_class_id', __('academic_class_id'))->default(0)->rules('required');
