...
class FeesDataImportController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('actions', __('Actions'))->display(function () {
            $validateLink = url("admin/fees-data-import-validate?id={$this->id}");
            $importLink = url("admin/fees-data-import-do-import-optimized?id={$this->id}");
            $retryLink = url("admin/fees-data-import-retry?id={$this->id}");
            $duplicateLink = url("admin/fees-data-import-duplicate?id={$this->id}");
    ...
    public function validate()
    {
        ...
        try {
            ...
            if ($validation['valid']) {
                $importUrl = url("admin/fees-data-import-do-import-optimized?id={$import->id}");
